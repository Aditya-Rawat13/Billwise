...
def process(img_path):
    ...
    if __name__ == "__main__":
        test_image_path = Path("123.jpg")  # Replace with the actual test image path

    # Call the process function and get the final processed image
    processed_image = process(test_image_path)

    # Display the returned processed image
    show_wait_destroy("Processed Image", processed_image)
